        ...
        <div class="glass-card rounded-[18px] p-8 shadow-medium transition duration-300 animate-slide-up">
          ...
          @if (mode === 'login') {
            ...
            <div class="mt-8">
              ...
              <div class="mt-6 flex justify-center w-full min-h-[44px]">
                @if (isGoogleSdkLoaded()) {
                  <div id="googleBtnContainer" class="w-full max-w-[320px] rounded-xl overflow-hidden shadow-sm"></div>
                } @else {
...
export class LoginComponent implements OnInit {
  ...
  private initializeGoogleSignIn(clientId: string) {
    ...
    try {
      ...
      // Render the visible native Google button overlay after view loads
      setTimeout(() => {
